...
import Header from './menu'; // นำเข้าคอมโพเนนต์ Header
...
const MyPetForm: React.FC = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow py-8 px-4 bg-blue-100 ">
      <div className="container max-w-md bg-grey p-4 rounded-lg shadow-md mx-auto">
      <img src="https://prod-mfp-imgsrv.tillitsdone.com/uploads/medium__386c3d9f4d.png" alt="รูปน้องสุข" className="mx-auto mb-4 w-32 h-32 rounded-full" />
          {submittedData ? ( // ถ้ามีข้อมูลที่ถูกส่งให้แสดง MyPetShow
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-x-4">
                ...
                <button type="button" onClick={handleReset} className="bg-red-500 text-white px-4 py-2 rounded">Reset</button>
              </div>
            </form>
          )}
        </div>
